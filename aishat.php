                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5 col-md-6">
                            <div class="about-col-left">
                                <img class="img-fluid" src="Aishat.jpg" />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="about-col">
                                <h4>Education</h4>
                                <p>Medical School - University of Ilorin Health Science Center.</p>
                                <p>Residency in surgery - University of Ilorin Health Science Center.</p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="about-col">
                                <h4>Experience</h4>
                                <p>Medical School - University of Ilorin Health Science Center.</p>
                                <p>Residency in Family Medicine - University of Ilorin Health Science Center.</p>
                            </div>
                        </div>
                    </div>
                </div>
